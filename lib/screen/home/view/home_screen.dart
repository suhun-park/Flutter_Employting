...
import 'package:flutting/screen/home/page/view/home_search_page.dart';
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Obx (() => _homeController.homeSearchLoading.value ? Row(
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (value){
                        ...
                        print(_homeController.homeSearchText);
                      },
                    ),
                  ),
                  IconButton(onPressed: (){
                    Get.to(() => HomeSearchPage(),arguments:_homeController.homeSearchText);
            ...
            StreamBuilder<List<HomeModel>>(
              initialData: _homeController.homeList,
